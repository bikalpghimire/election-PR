...
class ElectionApp:
    def __init__(self, root):
        ...
        tk.Label(
            ...
            text="Qualified Parties",
            font=(FONT_NAME, 14, "bold"),
            bg="white",
            fg="#2c3e50"
        ).pack(anchor="w", padx=10, pady=(5,2))

        self.tree_qualified = ttk.Treeview(
            self.qualified_frame,
    ...
    def fetch_from_web(self):
        ...
        try:
            ...
            qualified_parties = set(res["Party"])
            unqualified_df = df[~df["Party"].isin(qualified_parties)].copy()
    ...
    def update_chart(self):
        ...
        for t in texts: t.set_visible(False); t.set_fontsize(13); t.set_fontweight("bold")
